      ...
      <Navbar className="max-w-full sticky top-0 z-10 h-max w-full rounded-none px-4 py-2 lg:px-8 lg:py-4">
        <div className="flex text-blue-gray-900">
          ...
          <Typography as="a" href="#" className="mr-4 cursor-pointer py-1.5 font-medium">
            <a href="/catalogo">
            <img src="/images/logo.png" className="h-16 w-16 mt-2" alt="Logo" /></a>
          </Typography>
        ...
        <MobileNav open={openNav}>
          {!token && (
            <div className="flex items-center gap">
              <a href="/inicio">
                <Button fullWidth color="green" variant="text" size="sm">
                  <span>Log In</span>
                </Button>
              </a>
              <a href="/registro">
          ...
          {token && (
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button variant="" size="sm" className="w-48 h-12 mt-5" onClick={logout}>
                <a href="/catalogo" className="flex items-center">
                  Cerrar sesión
                </a>
              </Button>
