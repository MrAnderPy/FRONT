...
export async function generarExcel(data) {
  ...
  const sheet = workbook.addWorksheet("Usuarios"); // Cambiar el nombre de la hoja si es necesario
 ...
 sheet.addRow([]);
  ...
  sheet.getCell("C6").value = "Apellido";
  sheet.getCell("D6").value = "Cédula";
  sheet.getCell("E6").value = "Correo";
  sheet.getCell("F6").value = "Teléfono";
  sheet.getCell("G6").value = "Rol";
  sheet.getCell("H6").value = "Estado";
  ...
  saveAs(blob, "Usuarios.xlsx"); // Cambiar el nombre del archivo si es necesario
}
