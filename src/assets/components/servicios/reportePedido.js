...
export async function generarExcel(data) {
  ...
  // Encabezados
  sheet.getCell("A6").value = "ID Pedido";
  ...
  saveAs(blob, "Pedidos.xlsx"); // Cambiar el nombre del archivo si es necesario
}
